...
const EmployerRevenuePie = () => {
  const { data, isLoading, error } = useQueryCompanyRevenuePieData();
  ...
  return (
    <Card>
      <CardHeader className="items-center pb-0">
        ...
        <CardDescription> Breakdown of company premium users</CardDescription>
      </CardHeader>
...
export default EmployerRevenuePie;
